<template>
  <div class="info">
    <el-row type="flex" style="text-align:center;margin-bottom:10px;">
      ...
      <el-select v-model="capacitySel" placeholder="请选择" @change="capacityChange">
        <el-option v-for="item in Object.keys(basis)" :key="item" :label="item+' μL'" :value="item"></el-option>
      </el-select>
    </el-row>
    <el-row type="flex" style="margin-bottom:10px;">
      <el-checkbox v-model="isCustomized" @change="customerChange" style="line-height: 36px;">自定义检定点</el-checkbox>
      <label class="custom-label">检定点1</label>
      <el-input class="custom-input" v-model="pointOne"></el-input>
      <span class="custom-span">μL</span>
      <label class="custom-label">检定点2</label>
      <el-input class="custom-input" v-model="pointTwo"></el-input>
      <span class="custom-span">μL</span>
      <label class="custom-label">检定点3</label>
      <el-input class="custom-input" v-model="pointThree"></el-input>
      <span class="custom-span">μL</span>
    </el-row>
